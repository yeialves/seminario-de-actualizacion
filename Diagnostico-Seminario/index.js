...
app.post("/edit/:id", function(req, res) {
    ...
    let editContactQuery = "UPDATE Contact SET name = ?, surname = ?, address = ? WHERE id = ?";
    
    // Ejecutar la consulta SQL para actualizar el contacto por su ID en la tabla Contact
    conexion.query(editContactQuery, [newData.Name, newData.Surname, newData.Address, contactId], function(err, result) {
        if (err) {
